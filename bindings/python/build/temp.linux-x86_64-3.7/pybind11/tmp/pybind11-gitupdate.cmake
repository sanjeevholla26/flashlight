...
execute_process(
  COMMAND "/usr/bin/git" show-ref 9a19306fbf30642ca331d0ec88e7da54a96860f9
  WORKING_DIRECTORY "/opt/wav2vec/flashlight/bindings/python/build/temp.linux-x86_64-3.7/pybind11/src/pybind11"
...
if("${show_ref_output}" MATCHES "refs/remotes/9a19306fbf30642ca331d0ec88e7da54a96860f9")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "9a19306fbf30642ca331d0ec88e7da54a96860f9")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "9a19306fbf30642ca331d0ec88e7da54a96860f9")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 9a19306fbf30642ca331d0ec88e7da54a96860f9
  WORKING_DIRECTORY "/opt/wav2vec/flashlight/bindings/python/build/temp.linux-x86_64-3.7/pybind11/src/pybind11"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/opt/wav2vec/flashlight/bindings/python/build/temp.linux-x86_64-3.7/pybind11/src/pybind11/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/opt/wav2vec/flashlight/bindings/python/build/temp.linux-x86_64-3.7/pybind11/src/pybind11/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
